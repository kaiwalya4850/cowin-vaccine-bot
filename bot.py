...
def cowin(user_data: Dict[str, str]) -> str:
    ...
    print_flag = 'Y'
    URL = "https://cdn-api.co-vin.in/api/v2/appointment/sessions/public/calendarByPin?pincode={}&date={}".format(POST_CODE, date_str[0])
...
def main() -> None:
    ...
    updater = Updater("1775475449:AAHcSpbaVde-g-4P_pu8JVxCpFKhyPfc7rI")
